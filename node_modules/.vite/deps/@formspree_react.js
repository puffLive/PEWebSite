...
var require_dist = __commonJS({
  "node_modules/@formspree/core/dist/index.js"(exports, module) {
    ...
    var Y = (e, r) => {
      for (var t in r) g2(e, t, { get: r[t], enumerable: true });
    };
    var K2 = (e, r, t, o) => {
      if (r && typeof r == "object" || typeof r == "function") for (let s of L(r)) !V.call(e, s) && s !== t && g2(e, s, { get: () => r[s], enumerable: !(o = j2(r, s)) || o.enumerable });
      return e;
    };
      ...
      submitForm(s, i) {
        return h(this, arguments, function* (r, t, o = {}) {
          ...
          function m(f) {
            return h(this, null, function* () {
              try {
                ...
                if (M2(n)) {
                  if (P2(n)) return Array.isArray(n.errors) ? new p(...n.errors) : new p({ message: n.error });
                  if (_2(n)) return new b2(n.stripe.paymentIntentClientSecret, n.resubmitKey);
                  if (w2(n)) return new S({ next: n.next });
                }
          ...
          if (this.stripe && o.createPaymentMethod) {
            ...
            if (f.error) return new p({ code: "STRIPE_CLIENT_ERROR", field: "paymentMethod", message: "Error creating payment method" });
            E2(t, "paymentMethod", f.paymentMethod.id);
            let d2 = yield m(t);
            if (d2.kind === "error") return d2;
