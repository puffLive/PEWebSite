...
var ToggleButton = React3.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React3.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded);
  const toggleButtonGroupButtonContextPositionClassName = React3.useContext(ToggleButtonGroupButtonContext_default);
