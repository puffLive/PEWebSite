...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React11.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React11.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React11.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React11.Children.map(children, (child) => {
        if (React11.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function joinChildren(children, separator) {
  const childrenArray = React12.Children.toArray(children).filter(Boolean);
  return childrenArray.reduce((output, child, index) => {
    output.push(child);
    if (index < childrenArray.length - 1) {
      output.push(React12.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React12.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DRPVE7TB.js.map
