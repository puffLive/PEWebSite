...
var IconButton = React.forwardRef(function IconButton2({ label: label$1, className, icon: Icon, renderIcon, onClick, style, ...rest }, ref) {
  const { styles, labels } = useLightboxProps();
  return React.createElement("button", { ref, type: "button", "aria-label": label(labels, label$1), className: clsx(cssClass(ELEMENT_BUTTON), className), onClick, style: { ...style, ...styles.button }, ...rest }, renderIcon ? renderIcon() : React.createElement(Icon, { className: cssClass(ELEMENT_ICON), style: styles.icon }));
});
...
function ImageSlide({ slide: image, offset, render, rect, imageFit, imageProps, onClick, onLoad, style }) {
  ...
  return React.createElement(
    React.Fragment,
    null,
    React.createElement("img", { ref: setImageRef, onLoad: handleOnLoad, onError, onClick, draggable: false, className: clsx(cssClass(slideImagePrefix()), cover && cssClass(slideImagePrefix("cover")), status !== SLIDE_STATUS_COMPLETE && cssClass(slideImagePrefix("loading")), imagePropsClassName), style: { ...defaultStyle, ...style, ...imagePropsStyle }, ...restImageProps, alt: image.alt, sizes, srcSet, src: image.src }),
...
function Controller({ children, ...props }) {
  ...
  return React.createElement("div", { ref: handleContainerRef, className: clsx(cssClass(cssContainerPrefix()), cssClass(CLASS_FLEX_CENTER)), style: {
    ...
    ...styles.container
  }, ...controller.aria ? { role: "presentation", "aria-live": "polite" } : null, tabIndex: -1, ...registerSensors }, containerRect && React.createElement(
...
function CarouselSlide({ slide, offset }) {
  ...
  const renderSlide = () => {
    ...
    if (!rendered && isImageSlide(slide)) {
      rendered = React.createElement(ImageSlide, { slide, offset, render, rect: slideRect, imageFit, imageProps, onClick: offset === 0 ? () => onClick === null || onClick === void 0 ? void 0 : onClick({ index: currentIndex }) : void 0 });
    }
  ...
  return React.createElement("div", { ref: containerRef, className: clsx(cssClass(cssSlidePrefix()), offset === 0 && cssClass(cssSlidePrefix("current")), cssClass(CLASS_FLEX_CENTER)), onClick: handleBackdropClick, style }, renderSlide());
}
function Placeholder() {
  const style = useLightboxProps().styles.slide;
  return React.createElement("div", { className: cssClass("slide"), style });
}
function Carousel({ carousel }) {
  ...
  } }, items.map(({ key, slide, offset }) => slide ? React.createElement(CarouselSlide, { key, slide, offset }) : React.createElement(Placeholder, { key })));
}
...
function Portal({ children, animation, styles, className, on, portal, close }) {
  ...
  return mounted ? (0, import_react_dom.createPortal)(React.createElement("div", { ref: handleRef, className: clsx(className, cssClass("root"), cssClass(cssPrefix$1()), cssClass(CLASS_NO_SCROLL_PADDING), visible && cssClass(cssPrefix$1("open"))), role: "presentation", "aria-live": "polite", style: {
...
//# sourceMappingURL=chunk-6CFIVBNR.js.map
