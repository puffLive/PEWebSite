...
} from "./chunk-7Y75PSDB.js";
import {
  useSlider,
  valueToPercent
} from "./chunk-ZBFACSQD.js";
import {
  ClickAwayListener
} from "./chunk-333ICLWB.js";
import {
  FocusTrap,
  useModal
} from "./chunk-ZYR5RFJW.js";
import {
  Portal
} from "./chunk-H7AEH5SC.js";
import {
  useBadge
} from "./chunk-HRE7DKDY.js";
import {
  require_react_dom
...
} from "./chunk-DDKWZZBR.js";
import {
  useEnhancedEffect_default
} from "./chunk-RBXZRSTM.js";
import {
  setRef,
  useControlled,
  useForkRef,
  useId
} from "./chunk-SSE5M33Y.js";
import {
  clsx_default
} from "./chunk-FVY2H5XM.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-AQR4TIGB.js";
import {
  clamp_default,
  composeClasses
} from "./chunk-YH3ZBKKN.js";
import {
  init_formatMuiErrorMessage
} from "./chunk-E2FIZEPU.js";
import {
  require_jsx_runtime
...
var Badge = React3.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime4.jsxs)(Root, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime3.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
var popupClasses = generateUtilityClasses(COMPONENT_NAME6, ["root", "open"]);
...
var TransitionContext = React24.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React25.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React26.useState(true);
  const hasPendingExitTransition = React26.useRef(false);
  const registeredTransitions = React26.useRef(0);
  const [hasTransition, setHasTransition] = React26.useState(false);
  const previousRequestEnter = React26.useRef(requestEnter);
  React26.useEffect(() => {
  ...
  const handleExited = React26.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React26.useCallback(() => {
...
var PopupContext = React27.createContext(null);
if (true) {
...
var Popup = React28.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React28.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React29.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime12.jsx)(Popup, _extends({
    keepMounted: true
  }, rootProps, {
    open,
    anchor,
...
var MenuButton = React31.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
var InnerMenuItem = React34.memo(React34.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React34.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
  ...
  return (0, import_jsx_runtime14.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime14.jsx)(InnerMenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
var Modal = React35.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
  ...
  return (0, import_jsx_runtime15.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime16.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime15.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime15.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(React36.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React37.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React37.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React37.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React38.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime19.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime18.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime18.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime18.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React39.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
function useOption(params) {
  ...
  const selectOption = React40.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
var InnerOption = React42.memo(React42.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React42.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
function useSelect(props) {
  ...
  const getItemDomElement = React43.useCallback((itemId) => {
    var _subitems$get$ref$cur, _subitems$get;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React43.useRef(open);
  useEnhancedEffect_default(() => {
...
function SelectProvider(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime23.jsx)(ListContext.Provider, {
      value: listContextValue,
      children
    })
  });
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime24.jsx)(React45.Fragment, {
...
var Select = React45.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React45.Fragment, {
    children: [(0, import_jsx_runtime24.jsx)(Button3, _extends({}, buttonProps, {
    ...
    })), buttonDefined && (0, import_jsx_runtime24.jsx)(Popup, _extends({
      slots: {
        root: PopupComponent
      }
    }, popupProps, {
      children: (0, import_jsx_runtime24.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime24.jsx)(SelectProvider, {
          value: contextValue,
          children
        })
      }))
    })), (0, import_jsx_runtime24.jsx)("input", _extends({}, getHiddenInputProps(), {
      autoComplete
    }))]
  });
});
...
var Slider = React46.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime26.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime26.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime27.jsxs)(Thumb, _extends({
        ...
        children: [(0, import_jsx_runtime26.jsx)(Input3, _extends({
          ...
          value: values[index2]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime26.jsx)(ValueLabel, _extends({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React48.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsx)(ClickAwayListener, _extends({}, clickAwayListenerProps, {
...
function FirstPageIconDefault() {
  return _span22 || (_span22 = (0, import_jsx_runtime31.jsx)("span", {
    children: "|⇽"
  }));
}
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime35.jsx)(TabsContext.Provider, {
...
var Tabs = React56.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime36.jsx)(TabsProvider, {
      value: contextValue,
      children
    })
  }));
...
function TabsListProvider(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime38.jsx)(ListContext.Provider, {
      value: listContextValue,
      children
    })
  });
...
var TabsList = React61.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime39.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime39.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
      children
    }))
  });
});
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GM27GYMO.js.map
