...
const CountUpPage = lazy(() =>
  import("../../../src/pages/components/count-up")
);
const ScrollbarPage = lazy(() =>
  import("../../../src/pages/components/scroll")
);
const LightboxPage = lazy(() =>
  import("../../../src/pages/components/lightbox")
);
const MarkdownPage = lazy(() =>
  import("../../../src/pages/components/markdown")
);
const CarouselsPage = lazy(() =>
  import("../../../src/pages/components/carousel")
);
const MegaMenuPage = lazy(() =>
  import("../../../src/pages/components/mega-menu")
);
const TextMaxLinePage = lazy(() =>
  import("../../../src/pages/components/text-max-line")
);
const NavigationBarPage = lazy(() =>
  import("../../../src/pages/components/navigation-bar")
);
const FormValidationPage = lazy(() =>
  import("../../../src/pages/components/form-validation")
);
const ScrollProgressPage = lazy(() =>
  import("../../../src/pages/components/scroll-progress")
);
