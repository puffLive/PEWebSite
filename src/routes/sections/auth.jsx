...
const LoginBackgroundPage = lazy(() =>
  import("../../../src/pages/auth/login-background")
);
const LoginCoverPage = lazy(() =>
  import("../../../src/pages/auth/login-cover")
);
const LoginIllustrationPage = lazy(() =>
  import("../../../src/pages/auth/login-illustration")
);
const RegisterBackgroundPage = lazy(() =>
  import("../../../src/pages/auth/register-background")
);
const RegisterCoverPage = lazy(() =>
  import("../../../src/pages/auth/register-cover")
);
const RegisterIllustrationPage = lazy(() =>
  import("../../../src/pages/auth/register-illustration")
);
