...
import MembersOnlyCourseDetailsLessonList from './members-only-course-details-lesson-list';

// ----------------------------------------------------------------------

export default function MembersOnlyCourseDetailsSummary({ course }) {
  return (
    <Stack spacing={5}>
      <MembersOnlyCourseDetailsLessonList lessons={course.lessons} />
...
MembersOnlyCourseDetailsSummary.propTypes = {
