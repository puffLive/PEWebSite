...
export default function MembersOnlyLandingFeaturedCourses({ courses }) {
        ...
        >
          <Carousel ref={carousel.carouselRef} {...carousel.carouselSettings}>
            {courses.map((course) => (
              ...
              >
                <MembersOnlyCourseItem course={course} vertical />
              </Box>
            ))}
          </Carousel>
        </CarouselArrows>
...
MembersOnlyLandingFeaturedCourses.propTypes = {
